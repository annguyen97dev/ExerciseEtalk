...
const CloseSlotModal = ({data, handleCloseSlot}) => {
    ...
    return (
        <div className="modal fade effect-scale" data-backdrop="static" data-keyboard="false" id="md-close-slot" tabIndex={-1} role="dialog" aria-labelledby="close-slot" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div className="modal-content">
                    <div className="modal-header  bg-danger">
                        <h5 className="modal-title tx-white" id="newCampaignTitle">Close available slot !!</h5>
                    ...
                    <div className="modal-footer bd-t-0 pd-t-0">
                        ...
                        <button type="button" className="btn btn-flat btn-sm tx-primary" onClick={_onSubmit}>Yes, close it</button>
                    </div>
                </div>
            </div>
        </div>
